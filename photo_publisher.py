...
def get_args():
    ...
    parser.add_argument("--chat_id", type=str, default=os.getenv("CHAT_ID"), help="Telegram channel ID")
    parser.add_argument("--token", type=str, default=os.getenv("TOKEN"), help="Telegram bot token")
